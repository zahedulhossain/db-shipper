...
ENV PHP_FPM_CONF_WWW_USER="www-data" \
    PHP_FPM_CONF_WWW_GROUP="www-data" \
    PHP_FPM_CONF_WWW_LISTEN=9000 \
    PHP_FPM_CONF_WWW_LISTEN_OWNER="www-data" \
    PHP_FPM_CONF_WWW_LISTEN_GROUP="www-data" \
    PHP_FPM_CONF_WWW_LISTEN_MODE=0660 \
    PHP_FPM_CONF_WWW_PM="dynamic" \
    PHP_FPM_CONF_WWW_PM_MAX_CHILDREN=5 \
    PHP_FPM_CONF_WWW_PM_START_SERVERS=2 \
    PHP_FPM_CONF_WWW_PM_MIN_SPARE_SERVERS=1 \
    PHP_FPM_CONF_WWW_PM_MAX_SPARE_SERVERS=3 \
    PHP_FPM_CONF_WWW_PM_PROCESS_IDLE_TIMEOUT="10s" \
    PHP_FPM_CONF_WWW_PM_MAX_REQUESTS=0
...
# So further installs from child images
# will download less dependencies.
